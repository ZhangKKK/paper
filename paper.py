...
class Segmenter(nn.Module):
    ...
    def forward(self, x, y):
        ...
        concat = torch.cat(x_low_c1, x_low_c2, x_low_c3, x_normal_c1, x_normal_c2, x_normal_3, out1)
        out = self.res_2(out1)
    ...
    for epoch in range(num_epochs):
        ...
        for x, y, x_s, x_t in loader_train:
            ...
            if (iter_count % show_every == 0):
                print('Iter: {}, D: {:.4}, G:{:.4}'.format(iter_count, D_error.data[0], S_error.data[0]))
